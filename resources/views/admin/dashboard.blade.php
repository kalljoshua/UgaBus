        ...
        <div class="animated fadeInUpShort">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="lightSlider" data-item="6" data-item-md="2" data-item-sm="1" data-pause="7000"
                         data-pager="false" data-auto="true"
                         data-loop="true">
                                ...
                                <div class="row justify-content-end">
                                    <div class="col">
                                        <ul id="myTab4" role="tablist"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab2" data-toggle="tab" href="#v-pills-tab2"
                                                   role="tab" aria-controls="tab2" aria-selected="false">Yesterday</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="w-10">
                                                            <a href="panel-page-profile.html" class="avatar avatar-lg">
                                                                <img src="/admin_inc/assets/img/dummy/u6.png" alt="">
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <h6>Sara Kamzoon</h6>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover earning-box">
                                                ...
                                                <tr>
                                                    <td class="w-10">
                                             <span class="round">
                                             <img src="/admin_inc/assets/img/dummy/u1.png" alt="user">
                                             </span>
                                                    </td>
                                                    <td>
                                                        <h6>Sara Kamzoon</h6>
                                                ...
                                                <tr>
                                                    <td class="w-10">
                                             <span class="round">
                                             <img src="/admin_inc/assets/img/dummy/u2.png" alt="user">
                                             </span>
                                                    </td>
                                                    <td>
                                                        <h6>Sara Kamzoon</h6>
                                                ...
                                                <tr>
                                                    <td class="w-10">
                                             <span class="round">
                                             <img src="/admin_inc/assets/img/dummy/u3.png" alt="user">
                                             </span>
                                                    </td>
                                                    <td>
                                                        <h6>Sara Kamzoon</h6>
                                                ...
                                                <tr>
                                                    <td class="w-10">
                                             <span class="round">
                                             <img src="/admin_inc/assets/img/dummy/u4.png" alt="user">
                                             </span>
                                                    </td>
                                                    <td>
                                                        <h6>Sara Kamzoon</h6>
                                                ...
                                                <tr>
                                                    <td class="w-10">
                                             <span class="round">
                                             <img src="/admin_inc/assets/img/dummy/u5.png" alt="user">
                                             </span>
                                                    </td>
                                                    <td>
                                                        <h6>Sara Kamzoon</h6>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body slimScroll" data-height="500">
                            <div class="media p-3 b-b">
                                <img class="mr-3 mt-1 w-40px" src="/admin_inc/assets/img/dummy/u4.png" alt="user">
                            ...
                            <div class="media p-3">
                                <img class="mr-3 w-40px" src="/admin_inc/assets/img/dummy/u1.png" alt="user">
                                <div class="media-body">
                                    <h6 class="mt-0">Sara Kamzoon</h6>
                                    vestibulum in vulputate at, tempus viverra turpis.
                                    <div class="media p-2 my-3 bg-light r-5">
                                        <a class="pr-3" href="#">
                                            <img class="mt-1 w-40px" src="/admin_inc/assets/img/dummy/u2.png"
                                                 alt="user">
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media p-2 my-3 r-5">
                                        <a class="pr-3" href="#">
                                            <img class="mt-1 w-40px" src="/admin_inc/assets/img/dummy/u3.png"
                                                 alt="user">
                                        </a>
                                        <div class="media-body">
                            ...
                            <div class="media p-3 r-5 yellow lighten-5">
                                <img class="mr-3 mt-1 w-40px" src="/admin_inc/assets/img/dummy/u6.png" alt="user">
                                <div class="media-body">
                            ...
                            <div class="media p-3">
                                <img class="mr-3 mt-1 w-40px" src="/admin_inc/assets/img/dummy/u5.png" alt="user">
                                <div class="media-body">
                                    <h6 class="mt-0">Ami Fro </h6>
                                    Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                    sollicitudin. Cras purus odio, vestibulum in
