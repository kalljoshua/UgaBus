        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link active"  href="/admin/staff/create" ><i class="icon icon-plus-circle"></i> Add New Staff User</a>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-9 m-0">
                                        ...
                                        <input type="text" name="staff_address" class="form-control r-0 light s-12" id="address"
                                               placeholder="Enter Address">
                                    </div>

                                    <div class="form-group col-3 m-0">
                                        <label for="inputCity" class="col-form-label s-12">City</label>
                                        <input type="text" name="staff_city" class="form-control r-0 light s-12" id="inputCity">
                                    </div>
                                </div>
                            </div>
                            <hr>
