        ...
        <div class="container-fluid text-white">
            ...
            <div class="row justify-content-between">
                <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                    ...
                    <li>
                        <a class="nav-link active" href="/admin/agents/create"><i class="icon icon-plus-circle"></i> Add
                            New Agent</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="animated fadeInUpShort">
            <div class="row my-3">
                <div class="col-md-7  offset-md-2">
                    <form method="post" action="/admin/agents/save" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="card no-b  no-r">
                            ...
                            {{--<div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-9 m-0">
                                        <label for="address" class="col-form-label s-12">Address</label>
                                        <input type="text" name="company_hq_address" class="form-control r-0 light s-12"
                                               id="address"
                                               placeholder="Enter Address">
                                    </div>
                                    ...
                                    <div class="form-group col-3 m-0">
                                        <label for="inputCity" class="col-form-label s-12">City</label>
                                        <input type="text" name="company_hq_city" class="form-control r-0 light s-12"
                                               id="inputCity">
                                    </div>
                                </div>
                            </div>
